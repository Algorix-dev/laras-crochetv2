            ...
            <section className="pt-4 pb-10 md:py-16">
              ...
              <Reveal>
                <div className="text-center mt-10 w-screen">
                  <Link to="/shop" className="sm:flex sm:justify-center sm:items-center bg-[var(--maroon)] px-8 py-3.5 sm:text-[14px] text-base font-bold uppercase tracking-widest text-white hover:bg-[var(--maroon-dark)] transition-colors">
                    Go to Shop
                  </Link>
                </div>
              </Reveal>
