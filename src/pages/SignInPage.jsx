...
export default function SignInPage() {
  ...
  function updateEmail(value) {
    setEmail(value);
    setEmailState(!value ? 'idle' : EMAIL.test(value) ? 'valid' : 'invalid');
    setError('');
  }
