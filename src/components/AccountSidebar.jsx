  ...
  return (
    <>
      ...
      <div className="md:hidden">
        ...
        {mobileOpen && (
          <div className="border border-t-0 border-[var(--line)] sm:text-[12px] uppercase">
      ...
      <nav className="hidden text-[18px] font-bold uppercase text-[var(--ink)] md:flex md:flex-col md:gap-4">
        {LINKS.map((link) => (
          <Link
            key={link.key}
            to={link.to}
