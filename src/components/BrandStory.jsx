...
export default function BrandStory() {
  return (
    ...
    >
      {/* ========================================================
          LARA BACKGROUND DECORATION

          IMPORTANT:
          This is intentionally positioned relative to the
          BrandStory section itself, NOT using the old Figma
          1920px frame coordinates.
