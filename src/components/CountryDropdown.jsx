...
export default function CountrySelector({
  ...
  const selected = COUNTRIES.find((country) => country.code === value) || COUNTRIES.find((country) => country.code === 'NG');
        ...
        >
          <div className="w-full max-w-[480px] max-h-[calc(100vh-32px)] bg-[#FFFCFC] shadow-[0px_8px_30px_rgba(0,0,0,0.25)] p-7 sm:p-8">
            ...
            <button
              ...
              className="w-full h-[52px] border border-[#D8D8D8] px-4 flex items-center justify-between text-left hover:border-[#999] cursor-pointer"
            >
              <span className="flex items-center gap-3 min-w-0">
                <img
                  ...
                  onError={(e) => { e.currentTarget.style.display = 'none'; }}
                />
                <span className="text-sm text-[#404040] truncate">{selected.name}</span>
              </span>
              <span className="flex items-center gap-2 text-sm text-[#777]">
                {selected.currency && <span>{selected.currency}</span>}
            ...
            {/* Country list */}
            <div className="mt-3 max-h-[330px] overflow-y-auto pr-1" role="listbox">
