        ...
        <div className="grid gap-10 md:grid-cols-[180px_1fr]">
          ...
          <div>
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
              <div>
                <h1 className="text-[36px] leading-[44px] font-bold uppercase tracking-[-0.02em] text-[#404040]">
                  Order History
                </h1>
              </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col gap-5">
                <p className="text-base leading-6 text-[#404040]">You haven&apos;t placed any orders yet.</p>
                <Link to="/shop" className="inline-flex items-center gap-1 text-base leading-6 text-[#404040] underline w-fit">
