        ...
        <>
          ...
          >
            ...
            <footer className="border-t border-[var(--line)] bg-white px-5 py-4">
              <Link to="/checkout" onClick={onClose} className={`block w-full bg-[var(--maroon)] py-4 text-center text-xs font-bold tracking-wider text-white hover:bg-[var(--maroon-dark)] ${!cartItems.length ? "pointer-events-none opacity-50" : ""}`}>
